...
def visualize_design(design_name, design):
	...
	for link in topology:
		...
		xx = (x1+x2)/2
		yy = (y1+y2)/2
		ax.arrow(xx,yy,(x2-x1)/2,(y2-y1)/2,zorder = 5, color = "#000000",length_includes_head=True, head_width = 0.25, head_length = 0.2, width = 0.1)
		ax.arrow(xx,yy,(x1-x2)/2,(y1-y2)/2,zorder = 5, color = "#000000",length_includes_head=True, head_width = 0.25, head_length = 0.2, width = 0.1)
	# Set canvas size
	ax.set_xlim(0,maxx) 
	ax.set_ylim(0,maxy) 
	# Store image
